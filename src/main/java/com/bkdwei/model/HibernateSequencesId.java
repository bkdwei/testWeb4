...
public class HibernateSequencesId implements java.io.Serializable {
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof HibernateSequencesId))
            return false;
        HibernateSequencesId castOther = (HibernateSequencesId) other;

        return ((this.getSequenceName() == castOther.getSequenceName())
                || (this.getSequenceName() != null && castOther.getSequenceName() != null
                        && this.getSequenceName().equals(castOther.getSequenceName())))
                && ((this.getSequenceNextHiValue() == castOther.getSequenceNextHiValue())
                        || (this.getSequenceNextHiValue() != null
                                && castOther.getSequenceNextHiValue() != null
                                && this.getSequenceNextHiValue()
                                        .equals(castOther.getSequenceNextHiValue())));
    }
    ...
    public int hashCode() {
        ...
        result = 37 * result
                + (getSequenceNextHiValue() == null ? 0 : this.getSequenceNextHiValue().hashCode());
        return result;
    }
